# =============================================================================
# ROOT MODULE VARIABLES — BurstLab Gen 5
# Ubuntu 24.04 LTS + Slurm 24.05.x
# =============================================================================
...
variable "cluster_name" {
  description = "Name prefix applied to every resource. Use 'burstlab-gen5' to distinguish from other generations in the same account."
  type        = string
  default     = "burstlab-gen5"
}
...
variable "head_node_ami" {
  description = "AMI ID for the head node. Must be the output of: packer build ami/ubuntu2404-slurm2405.pkr.hcl. Get the latest with: aws ec2 describe-images --owners self --filters 'Name=name,Values=burstlab-gen5-*'"
  type        = string
